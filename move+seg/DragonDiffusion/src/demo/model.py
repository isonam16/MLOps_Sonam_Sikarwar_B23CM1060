from DragonDiffusion.src.models.dragondiff import DragonPipeline
from DragonDiffusion.src.utils.utils import resize_numpy_image, split_ldm, process_move, process_drag_face, process_drag, process_appearance, process_paste
...
from DragonDiffusion.src.utils.alignment import align_face, get_landmark
import dlib
...
class DragonModels():
    ...
    def run_move(self, original_image, mask,dx,dy, prompt="move the object to given position"):
