        ...
        with gr.Row():
            with gr.Column():
                with gr.Box():
                    ...
                    # cv2.imwrite("boximage.png",img_draw_box)
            ...
            print(f"selected points_________{selected_points}")
            img_draw_box.select(
                segment_with_points, 
            ...
            print(f"global points_________{global_points}")
            # img_ref.save("image_ref.png")
            img_ref.edit(
                store_img_move,
                [img_ref],
