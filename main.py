...
def get_dataloaders(batch_size=128):
    # Standard ViT resolution is 224x224
...
def main():
    ...
    # EXPERIMENT 2: Optuna search for LoRA parameters
    ...
    def objective(trial):
        ...
        # wandb.init(project=WANDB_PROJECT, name=exp_name, reinit=True,
        ...
        # Build fresh model and apply LoRA
        base_model = build_base_model(num_classes=100, freeze_backbone=False) # PEFT handles freezing non-target
